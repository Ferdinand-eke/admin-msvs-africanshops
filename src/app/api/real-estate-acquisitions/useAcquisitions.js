...
export function useAdminSingleAcquisition(acquisitionId) {
  return useQuery(
    ['__acquisition', acquisitionId],
    () => adminGetSingleAcquisition(acquisitionId),
    {
...
export function useVerifyAcquisitionPayment() {
  ...
  return useMutation(
    ({ acquisitionId, adminNotes }) => adminVerifyAcquisitionPayment(acquisitionId, adminNotes),
    {
      onSuccess: (data) => {
...
export function useRejectAcquisitionPayment() {
  ...
  return useMutation(
    ({ acquisitionId, rejectionReason }) =>
      adminRejectAcquisitionPayment(acquisitionId, rejectionReason),
    {
      onSuccess: (data) => {
        if (data?.data?.success) {
...
export function useVerifyAcquisitionDocuments() {
  ...
  return useMutation(
    ({ acquisitionId, adminNotes }) =>
      adminVerifyAcquisitionDocuments(acquisitionId, adminNotes),
    {
      onSuccess: (data) => {
        if (data?.data?.success) {
...
export function useRejectAcquisitionDocuments() {
  ...
  return useMutation(
    ({ acquisitionId, rejectionReason }) =>
      adminRejectAcquisitionDocuments(acquisitionId, rejectionReason),
    {
      onSuccess: (data) => {
        if (data?.data?.success) {
...
export function useCompleteAcquisition() {
  ...
  return useMutation(
    ({ acquisitionId, adminNotes }) => adminCompleteAcquisition(acquisitionId, adminNotes),
    {
      onSuccess: (data) => {
        if (data?.data?.success) {
...
export function useCancelAcquisition() {
  ...
  return useMutation(
    ({ acquisitionId, cancellationReason }) =>
      adminCancelAcquisition(acquisitionId, cancellationReason),
    {
      onSuccess: (data) => {
        if (data?.data?.success) {
