...
export default function useAdminGetEstateProperties(params = {}) {
  ...
  return useQuery(
    ['__estateproperties', { limit, offset, title, numberOfRooms, minPrice, maxPrice, propertyUseCase, status, merchantId }],
    () => adminGetEstatePropertiess({ limit, offset, title, numberOfRooms, minPrice, maxPrice, propertyUseCase, status, merchantId }),
    {
