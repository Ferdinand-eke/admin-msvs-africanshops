...
function BasicInfoTab() {
	...
	return (
		<div>
			...
			<Typography style={{ fontSize: '12px', fontWeight: '800' }}>Country of Office</Typography>
			<Controller
				name="officeCountry"
				control={control}
				defaultValue={[]}
			...
			<Typography style={{ fontSize: '12px', fontWeight: '800' }}>State of Office</Typography>
			<Controller
				name="officeState"
				control={control}
				defaultValue={[]}
			...
			<Typography style={{ fontSize: '12px', fontWeight: '800' }}>L.G.A/County of Office</Typography>
			<Controller
				name="officeLga"
				control={control}
				defaultValue={[]}
