...
import useMarkets from 'src/app/api/markets/useMarkets';
		...
		() => [
			...
			// },
			{
				...
				Cell: ({ row }) => (
					<Typography
						component={Link}
						to={`/markets/list/${row.original._id}/${row.original.slug}`}
						className="underline"
						color="secondary"
						role="button"
					>
	...
	return (
		...
		>
			<Typography
				...
				variant="h5"
			>
				No markets in operation yet or Error retrieving this data ocuured!
			</Typography>
