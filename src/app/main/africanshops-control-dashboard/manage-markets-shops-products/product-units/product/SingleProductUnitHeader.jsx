 ...
 * The product header.
 */
function SingleProductUnitHeader() {
			...
			<div className="flex flex-col items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
				...
				>
					...
					>
						...
						<span className="flex mx-4 font-medium">Product Unit</span>
					</Typography>
				</motion.div>
				...
				{productId !== 'new' ? (
					<>
						...
						<Button
							...
							variant="contained"
							color="secondary"
							disabled={_.isEmpty(dirtyFields) || !isValid || updateProductUnit?.isLoading}
					...
					<Button
						...
						variant="contained"
						color="secondary"
						disabled={_.isEmpty(dirtyFields) || !isValid || addNewProductUnit?.isLoading}
...
export default SingleProductUnitHeader;
