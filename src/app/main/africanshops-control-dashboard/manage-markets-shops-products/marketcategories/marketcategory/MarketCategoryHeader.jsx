...
function MarketCategoryHeader() {
	...
	function handleCreateProduct() {
		...
		// 	.unwrap()
		// 	.then((data) => {
		// 		navigate(`/market-categories/list/${data.id}`);
		// 	});
	}
			...
			<div className="flex flex-col items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
				...
				>
					...
					>
						...
						<span className="flex mx-4 font-medium">Market-category</span>
					</Typography>
				</motion.div>
				...
				{productId !== 'new' ? (
					<>
						<Button
							...
							variant="contained"
							color="secondary"
							disabled={deletMarketCat?.isLoading}
						...
						<Button
							...
							variant="contained"
							color="secondary"
							disabled={_.isEmpty(dirtyFields) || !isValid || updateMarketCat?.isLoading}
					...
					<Button
						...
						variant="contained"
						color="secondary"
						disabled={_.isEmpty(dirtyFields) || !isValid || addNewMarketCat?.isLoading}
...
export default MarketCategoryHeader;
