						...
						>
							<input
								...
								onChange={async (e) => {
									...
									// console.log("DEFAULT=VALUE", newImage)
									// console.log("ADDED=VALUE", newImage) , ...value
									onChange([newImage]);
								}}
							/>
							<FuseSvgIcon
						...
						<>
							{
								...
								getValues()?.categoryimage && (
									<div
										...
										tabIndex={0}
										className={clsx(
											'mt-4 productImageItem flex items-center justify-center relative w-128 h-128 rounded-16 mx-12 mb-24 overflow-hidden cursor-pointer outline-none shadow hover:shadow-lg',
											getValues()?._id === value && 'featured'
										)}
										// key={media.id}
									>
										<FuseSvgIcon className="productImageFeaturedStar">
