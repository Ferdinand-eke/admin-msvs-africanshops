				...
				{productId !== 'new' ? (
					<>
						<Button
							...
							disabled={deleteProdCat?.isLoading}
						>
							Remove
						</Button>
						<Button
							...
							variant="contained"
							color="secondary"
							disabled={_.isEmpty(dirtyFields) || !isValid || updateProdCat?.isLoading}
					...
					<Button
						...
						variant="contained"
						color="secondary"
						disabled={_.isEmpty(dirtyFields) || !isValid || addNewProdCat?.isLoading}
...
export default SingleProductCategoryHeader;
