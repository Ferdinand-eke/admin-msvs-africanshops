 ...
 * The product header.
 */
function SinglePostCategoryHeader() {
	...
	function handleCreateProduct() {
		...
		// 	.unwrap()
		// 	.then((data) => {
		// 		navigate(`/postcategories/list/${data.id}`);
		// 	});
	}
			...
			<div className="flex flex-col items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
				...
				>
					...
					>
						...
						<span className="flex mx-4 font-medium">Post Categories</span>
					</Typography>
				</motion.div>
...
export default SinglePostCategoryHeader;
