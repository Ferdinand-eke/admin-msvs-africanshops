...
function BasicInfoTab() {
	...
	return (
		<div>
			<Typography style={{ fontSize: '12px', fontWeight: '800' }}>Country of this state?</Typography>
			<Controller
      ...
      /> */}
			...
			<Typography style={{ fontSize: '12px', fontWeight: '800' }}>Are we operational in this state?</Typography>
			<Controller
				name="isInOperation"
				control={control}
				defaultValue={[]}
			...
			<Typography style={{ fontSize: '12px', fontWeight: '800' }}>Publish this state?</Typography>
			...
			<Typography style={{ fontSize: '12px', fontWeight: '800' }}>Feature this state?</Typography>
