	...
	const usercolumns = useMemo(
		() => [
			...
			},
			{
				...
				Cell: ({ row }) => <Typography variant="body2">{row?.original?.title || 'N/A'}</Typography>
			},
			{
			...
			},
			{
				...
				header: 'Rooms',
				Cell: ({ row }) => <Typography variant="body2">{row?.original?.numberOfRooms || 0}</Typography>
			},
			{
				accessorKey: 'price',
				header: 'Price',
