...
function AcquisitionsTab({ propertyId }) {
  ...
  const { data: acquisitionsData, isLoading, isFetching } = useAdminAcquisitions({
    limit,
    offset,
  });
  ...
  return (
    <Box className="w-full">
      ...
      <Card elevation={1} className="mb-24">
        <CardContent>
          ...
          <Card elevation={1}>
            <CardContent>
              <Box className="flex items-center justify-between">
                ...
                <FuseSvgIcon size={32} className="text-blue-600">
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
        ...
        <MenuItem onClick={() => handleActionClick('cancel')} className="text-red-600">
      ...
      <Dialog open={actionDialogOpen} onClose={() => setActionDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          {selectedAcquisition && (
            <Box className="space-y-16">
              ...
              <TextField
                fullWidth
                label={actionType.includes('reject') || actionType.includes('cancel') ? 'Reason' : 'Notes'}
                multiline
                rows={3}
                value={actionNotes}
        ...
        <DialogActions className="px-24 pb-16">
          ...
          <Button
            ...
            variant="contained"
            color={
              actionType.includes('reject') || actionType.includes('cancel') ? 'error' : 'primary'
            }
            ...
            <Box className="space-y-16">
              <Box>
                ...
                <Box className="flex items-center gap-12 mt-8">
                  <Avatar src={selectedAcquisition.buyer?.avatar} className="w-48 h-48">
