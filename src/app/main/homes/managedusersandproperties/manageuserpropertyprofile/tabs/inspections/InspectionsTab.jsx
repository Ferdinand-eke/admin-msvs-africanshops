...
function InspectionsTab({ propertyId }) {
	...
	const inspectionsForDate = mockInspections.filter((inspection) => isSameDay(inspection.date, selectedDate));
		...
		<Box className="w-full">
			...
			>
				<Typography variant="body2">
					Note: Inspection scheduling API is currently under development. This is a placeholder interface.
				</Typography>
			</Alert>
