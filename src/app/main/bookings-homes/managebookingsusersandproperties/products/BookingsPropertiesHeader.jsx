 ...
 * The products header.
 */
function BookingsPropetiesHeader() {
	...
	return (
		<div className="flex space-y-12 sm:space-y-0 flex-1 w-full items-center justify-between py-8 sm:py-16 px-16 md:px-24">
			...
			>
				<Typography className="text-16 md:text-24 font-extrabold tracking-tight">Manage Merchants And Booking Listings</Typography>
			</motion.span>
			...
			<div className="flex flex-1 items-center justify-end space-x-8">
				...
				>
					...
					>
						...
						<span className="mx-4 sm:mx-8">Bookings</span>
					</Button>
				</motion.div>
			</div>
		</div>
...
export default BookingsPropetiesHeader;
