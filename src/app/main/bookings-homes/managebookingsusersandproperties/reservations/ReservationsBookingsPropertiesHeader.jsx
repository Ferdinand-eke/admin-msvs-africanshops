 ...
 * The products header.
 */
function ReservationsBookingsPropertiesHeader(props) {
	...
	return (
		<div className="flex space-y-12 sm:space-y-0 flex-1 w-full items-center justify-between py-8 sm:py-16 px-16 md:px-24">
			...
			>
				<Typography className="text-16 md:text-24 font-extrabold tracking-tight">Reservations On Booking Properties</Typography>
			</motion.span>
			...
			<div className="flex flex-1 items-center justify-end space-x-8">
				...
				>
					...
					>
						...
						<span className="mx-4 sm:mx-8">Reservations</span>
					</Button>
					<Button
					...
					>
						...
						<span className="mx-4 sm:mx-8">Cancelled Reservations</span>
					</Button>
				</motion.div>
			</div>
		</div>
...
export default ReservationsBookingsPropertiesHeader;
